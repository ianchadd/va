...
SESSION_CONFIGS = [
    dict(
        name='pilot_session_survey',
        display_name='Pilot session: attitudes check',
    ...
    dict(
        ...
        max_earning=25,
        failure_tracking=0, # 0 for no move, 1 for bad move
        turnlength=5, # in seconds, must divide 60 evenly
        turnsperminute=int(60/turnlength)
        roundlength=2*turnsperminute, # in seconds, only modify minute integer
        uq_error='Check your answer.',
        va_initial_prediction_rate = 2,
        doc="""
