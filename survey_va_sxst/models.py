...
#gender attitudes
    ...
    FEHOME = models.IntegerField(
        label = 'Women should take care of running their home and leave running the country up to men.',
        choices = [[5,'Strongly Agree'],
                   [4,'Agree'],
                   [3,'Neither Agree nor Disagree'],
                   [2,'Disagree'],
    ...
    FEPOL = models.IntegerField(
        label = 'Most men are better suited emotionally for politics than are most women.',
        choices = [[5,'Strongly Agree'],
                   [4,'Agree'],
                   [3,'Neither Agree nor Disagree'],
                   [2,'Disagree'],
